...
const REQUESTED = [
  ...
  "EURCHF", "EURCAD", "GBPNZD", "GBPCAD", "NZDCAD", "CADJPY", "CHFJPY",
  "EURNOK", "EURSEK", "USDSGD", "SGDJPY", "USDNOK", "USDSEK", "USDZAR",
  "USDHKD", "ZARJPY", "EURTRY", "USDTRY", "EURHUF", "EURPLN", "USDPLN",
  "XPTUSD", "XPDUSD", "XCUUSD", "XAUJPY", "XAUEUR", "XAUGBP", "XAUAUD",
  "XAUCAD", "XAUCHF", "XAUNZD", "XAGJPY"
];
