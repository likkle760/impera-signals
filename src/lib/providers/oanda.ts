...
const OANDA_SYMBOLS: Record<string, string> = {
  ...
  EURCHF: "EUR_CHF", EURCAD: "EUR_CAD", GBPNZD: "GBP_NZD", GBPCAD: "GBP_CAD",
  NZDCAD: "NZD_CAD", CADJPY: "CAD_JPY", CHFJPY: "CHF_JPY", EURNOK: "EUR_NOK",
  EURSEK: "EUR_SEK", USDSGD: "USD_SGD", SGDJPY: "SGD_JPY", USDNOK: "USD_NOK",
  USDSEK: "USD_SEK", USDZAR: "USD_ZAR", USDHKD: "USD_HKD", ZARJPY: "ZAR_JPY",
  EURTRY: "EUR_TRY", USDTRY: "USD_TRY", EURHUF: "EUR_HUF", EURPLN: "EUR_PLN",
  USDPLN: "USD_PLN",
  XPTUSD: "XPT_USD", XPDUSD: "XPD_USD", XCUUSD: "XCU_USD",
  XAUJPY: "XAU_JPY", XAUEUR: "XAU_EUR", XAUGBP: "XAU_GBP", XAUAUD: "XAU_AUD",
  XAUCAD: "XAU_CAD", XAUCHF: "XAU_CHF", XAUNZD: "XAU_NZD", XAGJPY: "XAG_JPY",
